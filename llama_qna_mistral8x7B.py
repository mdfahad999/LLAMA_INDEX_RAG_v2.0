...
def synthesis_model_fn(synthesis_model_id:str=None):
    ...
    llm = LlamaCPP(
        ...
        model_path=synthesis_model_id, # 4-bit model
        temperature=0.01,
        max_new_tokens=1024, # Increasing to support longer responses
        context_window=8192, # Mistral7B has an 8K context-window
        generate_kwargs={},
        # set to at least 1 to use GPU
        model_kwargs={"n_gpu_layers": 5}, # 40 was a good amount of layers for the RTX 3090, you may need to decrease yours if you have less VRAM than 24GB
...
class LLama_Index_qna:
    ...
    def RunQuestion(self,questionText):
        ...
        queryQuestion = "<s>[INST] You are a AI Assistant who is specialized on answering questions from PDF Documentss. Answer questions in a positive, helpful and empathetic way. Answer the following question: " + questionText.strip() + " [/INST]"
        return queryQuestion
    # @classmethod
    def qna(self,query:list=None):
